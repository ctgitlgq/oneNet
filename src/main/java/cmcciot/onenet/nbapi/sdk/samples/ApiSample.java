...
public class ApiSample {
    ...
    public static void main(String[] args) {
        String apiKey = "wDiNiuhUm2or1Zq9x4wacJArOtA=";
        String imei = "865820031700938";
        Integer objId = 3200;
        Integer objInstId = 0;
...
//        Device device = new Device("M5310-A", imei, "460040929906040");
//        LOGGER.info(deviceOpe.operation(device, device.toJsonObject()).toString());
        ...
        LOGGER.info(readOperation.operation(read, read.toJsonObject()).toString());
        // Write
